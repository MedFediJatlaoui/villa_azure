...
namespace IAWPSCOPED\Brick\Math;

use IAWPSCOPED\Brick\Math\Exception\DivisionByZeroException;
use IAWPSCOPED\Brick\Math\Exception\IntegerOverflowException;
use IAWPSCOPED\Brick\Math\Exception\MathException;
use IAWPSCOPED\Brick\Math\Exception\NegativeNumberException;
use IAWPSCOPED\Brick\Math\Exception\NumberFormatException;
use IAWPSCOPED\Brick\Math\Internal\Calculator;
/**
