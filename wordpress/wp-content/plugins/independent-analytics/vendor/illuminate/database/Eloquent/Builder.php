...
use Closure;
use Exception;
use IAWPSCOPED\Illuminate\Contracts\Database\Eloquent\Builder as BuilderContract;
use IAWPSCOPED\Illuminate\Contracts\Support\Arrayable;
use IAWPSCOPED\Illuminate\Database\Concerns\BuildsQueries;
use IAWPSCOPED\Illuminate\Database\Eloquent\Concerns\QueriesRelationships;
...
class Builder implements BuilderContract
{
     ...
     * @var string[]
     */
    protected $passthru = ['aggregate', 'average', 'avg', 'count', 'dd', 'doesntExist', 'doesntExistOr', 'dump', 'exists', 'existsOr', 'explain', 'getBindings', 'getConnection', 'getGrammar', 'implode', 'insert', 'insertGetId', 'insertOrIgnore', 'insertUsing', 'max', 'min', 'raw', 'rawValue', 'sum', 'toSql'];
    /**
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        $perPage = ($perPage instanceof Closure ? $perPage($total) : $perPage) ?: $this->model->getPerPage();
