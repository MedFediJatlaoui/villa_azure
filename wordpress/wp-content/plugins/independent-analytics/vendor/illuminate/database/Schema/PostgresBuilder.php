...
class PostgresBuilder extends Builder
{
    ...
    public function getColumnListing($table)
    {
        [$database, $schema, $table] = $this->parseSchemaAndTable($table);
        $table = $this->connection->getTablePrefix() . $table;
        $results = $this->connection->selectFromWriteConnection($this->grammar->compileColumnListing(), [$database, $schema, $table]);
    ...
    {
        $searchPath = $this->parseSearchPath(($this->connection->getConfig('search_path') ?: $this->connection->getConfig('schema')) ?: 'public');
