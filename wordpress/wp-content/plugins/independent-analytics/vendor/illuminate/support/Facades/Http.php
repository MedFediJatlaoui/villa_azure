...
class Http extends Facade
{
    ...
    {
        return \IAWPSCOPED\tap(static::getFacadeRoot(), function ($fake) use($callback) {
    ...
    {
        $fake = \IAWPSCOPED\tap(static::getFacadeRoot(), function ($fake) {
            static::swap($fake);
        });
    ...
    {
        return \IAWPSCOPED\tap(static::getFacadeRoot(), function ($fake) {
    ...
    {
        return \IAWPSCOPED\tap(static::getFacadeRoot(), function ($fake) use($url, $callback) {
